...
const CadastroColetor: React.FC = () => {
  return (
    <>
      <Header />
      <main>
        <img className="bg2-coletor" src={bg2} aria-hidden alt="" />
        <img className="bg3-coletor" src={bg3} aria-hidden alt="" />
        <section id="coletor" className="coletor">
          <div className="title">
            <h1>
              Cadastre-se como <strong>COLETOR</strong> agora e continue
            </h1>
            <strong>ajudando sua comunidade</strong>
          </div>
          <div className="form-coletor">
            <form
